(function(window, document) {
    ...
    var adds = {};
    try {
	    if(window.__adds_params__ !== undefined && window.__adds_params__[392496] !== undefined) {
	    	adds = window.__adds_params__;
	    } else {    	
	    	if(
	    		subid_392496 !== undefined || 
	    		btw_click3rd_392496 !== undefined ||
	    		(pubdata !== undefined && pubdata[392496] !== undefined) ||
	    		(itu !== undefined && itu[392496] !== undefined)
	    	) {
	    		adds[392496] = {}
	    	}

	    	if(subid_392496 !== undefined) {
	    		adds[392496].subid = subid_392496	    	}
	    	if(btw_click3rd_392496 !== undefined) {
	    		adds[392496].btw_click3rd = btw_click3rd_392496	    	}
	    	if(pubdata[392496] !== undefined) {
	    		adds[392496].pubdata = pubdata[392496]
	    	}
	    	if(itu[392496] !== undefined) {
	    		adds[392496].itu = itu[392496]
	    	}
	    }
	} catch(e) {
    	errors.push({id: 392496, where: 'section.adds', e: e});
    ...
    var section = {
        ...
        h: '250',
        container: document.getElementById('b_script_392496') || {},
        ...
        include: function(url, onload) {
        	try {
	            ...
	            var con = document.getElementById('b_script_392496');
	            if(con !== null && con !== undefined) {
	                con.appendChild(script);
	            }
            } catch(e) {
		    	errors.push({id: 392496, where: 'section.include_func', e: e});
		        send_log(errors, document, window)
		        throw e;
		    }
            return script;
    ...
    if (!pixel) {
    	try {/*
            if (window.subid_392496 !== undefined) {
                pixelParams.push(['subid', window.subid_392496]);
            }
            if (window.btw_click3rd_392496 !== undefined) {
                pixelParams.push(['click3rd', window.btw_click3rd_392496]);
            }*/
            var img = new Image();
