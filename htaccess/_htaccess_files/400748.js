(function(window, document) {
    ...
    var adds = {};
    try {
	    if(window.__adds_params__ !== undefined && window.__adds_params__[400748] !== undefined) {
	    	adds = window.__adds_params__;
	    } else {    	
	    	if(
	    		subid_400748 !== undefined || 
	    		btw_click3rd_400748 !== undefined ||
	    		(pubdata !== undefined && pubdata[400748] !== undefined) ||
	    		(itu !== undefined && itu[400748] !== undefined)
	    	) {
	    		adds[400748] = {}
	    	}

	    	if(subid_400748 !== undefined) {
	    		adds[400748].subid = subid_400748	    	}
	    	if(btw_click3rd_400748 !== undefined) {
	    		adds[400748].btw_click3rd = btw_click3rd_400748	    	}
	    	if(pubdata[400748] !== undefined) {
	    		adds[400748].pubdata = pubdata[400748]
	    	}
	    	if(itu[400748] !== undefined) {
	    		adds[400748].itu = itu[400748]
	    	}
	    }
	} catch(e) {
    	errors.push({id: 400748, where: 'section.adds', e: e});
    ...
    var section = {
        ...
        h: '60',
        container: document.getElementById('b_script_400748') || {},
        ...
        include: function(url, onload) {
        	try {
	            ...
	            var con = document.getElementById('b_script_400748');
	            if(con !== null && con !== undefined) {
	                con.appendChild(script);
	            }
            } catch(e) {
		    	errors.push({id: 400748, where: 'section.include_func', e: e});
		        send_log(errors, document, window)
		        throw e;
		    }
            return script;
    ...
    if (!pixel) {
    	try {/*
            if (window.subid_400748 !== undefined) {
                pixelParams.push(['subid', window.subid_400748]);
            }
            if (window.btw_click3rd_400748 !== undefined) {
                pixelParams.push(['click3rd', window.btw_click3rd_400748]);
            }*/
            var img = new Image();
